...
Sidebar.Material = function ( editor ) {
    ...
    var SMRow = new UI.Row();
    var SM = new UI.Checkbox( false ).onChange( update );
    var SMLinewidth = new UI.Number( 1 ).setWidth( '60px' ).setRange( 0, 100 ).onChange( update );

    SMRow.add( new UI.Text( 'Дом' ).setWidth( '90px' ) );
    SMRow.add( SM );
    SMRow.add( SMLinewidth );
